        ...
        for case in switch(numfile):
            if case(0):
                if Npsr == 0.0:                    
                   ...
                   colors01.append(random.randint(0,255))
                else:
                    if Ndrift > 100.0:                       
                       ...
                       colors021.append(random.randint(0,255))
                    else:
                       plot_x022.append(RA[i])
                       plot_y022.append(Dec[i])
                       size022.append(Npsr)
                       # colors022.append(Ndrift)
                       colors022.append(random.randint(0,255))
            break 
            if case(1):
               plot_x1.append(RA[i])
...
#    plt.colorbar(b3)
   ...
   # plt.plot(plot_x01,plot_y01, marker = 'o', color = 'r',markersize=6, alpha = 1,ls='None',mec='r',mew=1,fillstyle='none')
    ...
    idx=1.2;
    size022b= (size022/np.max(size022))**idx*20
    ...
    plt.colorbar(b2)
    idi = 0
    while idi < len(plot_x022):
        idj = idi
        while idj<len(plot_x022):
            if plot_x022[idi]<plot_x022[idj]:
                te = plot_x022[idi]
                plot_x022[idi] = plot_x022[idj]
                plot_x022[idj] = te
                te = plot_y022[idi]
                plot_y022[idi] = plot_y022[idj]
                plot_y022[idj] = te
            idj += 1
        idi += 1
