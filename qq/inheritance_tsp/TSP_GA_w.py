...
class TSP_WIN(object):
      def __init__(self, aRoot, aLifeCount = 100, aWidth = 560, aHeight = 330):
            ...
            self.initCitys()
            self.new()
            self.title("TSP (n:init g:start s:stop)")
      ...
      def initCitys(self):
            ...
            self.citys.append((104.82, 26.58,"六盘水"))  #
            self.citys.append((106.9, 27.7,"遵义"))  #
            self.citys.append((105.29, 27.32,"毕节"))  #
            self.citys.append((106.42, 26.14,"安顺"))  #
            ...
            for city in self.citys:
                  ...
                  node = self.canvas.create_oval(x - r, y -r, x + r, y + r,
                        ...
                        tags = "node",)
                  # if len(city) > 2:
                  #       text = self.canvas.create_text(x + r, y + r,text=city[2])
      ...
      def start(self, evt = None):
            ...
            while self.isRunning:
                  ...
                  self.title("TSP-gen: %d %s(n:init g:start s:stop)" % (self.ga.generation,self.ga.best.score))
                  self.canvas.update()
